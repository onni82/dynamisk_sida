		...
		<main>
			...
			<div>
				...
				<section>
					...
					<p>Self-taught in <span className="bold-text">HTML</span>, <span className="bold-text">JavaScript</span>,
						<span className="bold-text">SQL</span>, <span className="bold-text">PHP</span> and
						<span className="bold-text">Java</span>.</p>
					...
					<p>Have taken courses in <span className="bold-text">C++</span>, <span className="bold-text">Japanese</span>
						and <span className="bold-text">Korean</span>.</p>
				</section>
			</div>
		</main>
	);
